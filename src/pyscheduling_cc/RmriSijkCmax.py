...
class Heuristics():
    ...
    @staticmethod
    def constructive(instance: RmriSijkCmax_Instance, remaining_jobs_list : list[int] = None, is_random : bool = False):
    ...
    def list_heuristic(instance : RmriSijkCmax_Instance, rule : int = 1, decreasing : bool = False):
        ...
        return Heuristics.constructive(instance, remaining_jobs_list=jobs_list)
