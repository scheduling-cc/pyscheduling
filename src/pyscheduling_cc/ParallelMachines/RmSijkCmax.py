...
import pyscheduling_cc.ParallelMachines.ParallelMachines as ParallelMachines
...
class RmSijkCmax_Instance(ParallelMachines.ParallelInstance):
    ...
    def create_solution(self):
        return RmSijkCmax_Solution(self)
...
class Metaheuristics(ParallelMachines.Metaheuristics_Cmax):
    @staticmethod
