...
class risijCmax_Instance(SingleMachine.SingleInstance):
    ...
    def create_solution(self):
        return risijCmax_Solution(self)
...
@dataclass
class risijCmax_Solution(SingleMachine.SingleSolution):

    def __init__(self, instance: risijCmax_Instance = None, machine : SingleMachine.Machine = None, objective_value: int = 0):
        """Constructor of risijCmax_Solution

        Args:
            instance (risijCmax_Instance, optional): Instance to be solved by the solution. Defaults to None.
    ...
    def copy(self):
        copy_solution = risijCmax_Solution(self.instance)
...
class Heuristics(Methods.Heuristics_Cmax):
    ...
    def constructive(instance: risijCmax_Instance):
        ...
        solution = risijCmax_Solution(instance=instance)
