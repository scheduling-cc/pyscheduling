...
@dataclass
class sijwiTi_Solution(SingleMachine.SingleSolution):

    def __init__(self, instance: sijwiTi_Instance = None, machine : SingleMachine.Machine = None, objective_value: int = 0):
        """Constructor of sijwiTi_Solution

        Args:
            instance (sijwiTi_Instance, optional): Instance to be solved by the solution. Defaults to None.
    ...
    def copy(self):
        copy_solution = sijwiTi_Solution(self.instance)
...
class Heuristics():
    ...
    def ACTS(instance : sijwiTi_Instance):
        ...
        solution = sijwiTi_Solution(instance)
