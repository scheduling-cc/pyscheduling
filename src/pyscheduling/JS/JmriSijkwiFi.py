...
class JmriSijkwiFi_Instance(JobShop.JobShopInstance):
    ...
    def generate_random(cls, n: int, m: int, instance_name: str = "",
        ...
        """Random generation of JmriSijkwiFi_Instance problem instance
        Args:
        ...
        Returns:
            JmriSijkwiFi_Instance: the randomly generated instance
        """
