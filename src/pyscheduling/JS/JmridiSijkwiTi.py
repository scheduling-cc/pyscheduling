...
class JmridiSijkwiTi_Instance(JobShop.JobShopInstance):
    P: List[List[tuple]] = field(default_factory=list)  # Processing time
    ...
    def generate_random(cls, n: int, m: int, instance_name: str = "",
        ...
        """Random generation of JmridiSijkwiTi problem instance
        Args:
        ...
        Returns:
            JmridiSijkwiTi_Instance: the randomly generated instance
        """
